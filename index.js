...
/******** OWNER NUMBER**********/
const ownerNumber = ["6283856085455@s.whatsapp.net","6283856085455@s.whatsapp.net"] 
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','blue'),color('Follow ig:@riyanhadi2020','red'),color(']','blue'),color('ini qr mu tinggal scan aja','white'),color('YOU','red'),color('TUBE','blue'),color('Rynz 01','yellow'))
})
...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Hallo Kakak @${num.split('@')[0]}\Selamat Datang Di Group *${mdata.subject}* Intro kak/n/nAsal:/nUmur:/nAskot:`
				...
				teks = `Akhirnya lu keluar juga wkwkwk @${num.split('@')[0]} *JASA MU AKAN KAMI KENANG SELAMANYA`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
           ...
           return false
			...
			switch(command) {
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					client.sendMessage(from, vintage, image, {caption: 'nih anjim', quoted: mek})
                 ...
                 if (isLimit(sender)) return reply(ind.limitend(pusname))
                   ...
                   const aruga1 = q.substring(0, q.indexOf('|') - 0)
					...
					client.sendMessage(from, aruga, image, {caption: '*Nih kak jangan lupa subscribe Yt: Rynz 01', quoted: mek})
					await limitAdd(sender)
					break 
					case 'toxic':
					if (!isRegistered) return reply(ind.noregis())
					...
					client.sendMessage(from, aruga, image, {caption: 'Nih kak jangan lupa follow Ig:@riyanhadi2020', quoted: mek})
					await limitAdd(sender)
					break
					case 'sumery':
					if (!isRegistered) return reply(ind.noregis())
					...
					client.sendMessage(from, aruga, image, {caption: 'Nih Buat kamu,🤭', quoted: mek})
					await limitAdd(sender)
					break
					case 'blood':
					if (!isRegistered) return reply(ind.noregis())
					...
					client.sendMessage(from, aruga, image, {caption: 'Ini kak udah jadi', quoted: mek})
					await limitAdd(sender)
					break
					case 'firework':
					if (!isRegistered) return reply(ind.noregis())
					...
					client.sendMessage(from, arugazzz, image, {caption: 'Nih kak udah selesai jangan lupa follow ig @riyanhadi2020', quoted: mek})
					await limitAdd(sender)
					break
					case 'lava':
					if (!isRegistered) return reply(ind.noregis())
					...
					client.sendMessage(from, aruga, image, {caption: 'nih jangan lupa bahagia lu, jangan sedih mulu kan ada aku', quoted: mek})
					await limitAdd(sender)
					break
                case '1cak':
				    try {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Jangan lupa terimakasih'})
					} catch (e) {
                ...
                case 'slap':
                    ...
                    if (isLimit(sender)) return reply(ind.limitend(pusname))
					const slap =['anjing','babi lu','anak anjing','udah tolol nub Lagi','muka lo kek monyet','udah jomblo sendirian lagi dirumah tolol','so so an mau punya pacar muka aja kek monyet lepass dari kandang','ganteng doang di toxic aja dibilang baperan','pantek kau','bangsat kau','ku entod kalian nangis kau','memek lu semua','lihat anak anjing lagi baca','ganteng doang jemput cewe dipanggang','kamu cantik beb bullshit anjing cowo buaya','anak dajjal','puki lu','anjing ngajak gelud','sama hantu takut cupu ngentod','cupu cupu aja gausah bacot','kontol lu semua','bocah lu semua kontol','Anak anjing liat kamu anjing']
                ...
                case 'beritahoax':
					...
					reply('Makasih Riyan Foto profil baru nya🤭')
					break 
					case 'brainly':
					if (!isRegistered) return reply(ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				...
				case 'bcgc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 BROADCAST RYNZ BOT 」*\n\nDari Grup : ${groupName}\nPengirim : wa.me/${(sender.split('@')[0])}\nPesan : ${body.slice(6)}`)
						}
						reply('Succes Broadcast Group, jangan lupa follow ig @riyanhadi2020')
					}
					break 
					case 'pinterest':
					if (!isRegistered) return reply(ind.noregis())
          ...
          if (!isRegistered) return reply(ind.noregis())
            await client.sendMessage(from, `Pong!!!!\nSpeed: ${processTime(time, moment())} _Second_`)
               ...
               case 'help': 
				...
				case 'yt':
				if (!isRegistered) return reply(ind.noregis())
				client.sendMessage(from, {caption: '*Yt:Rynz 01* /n/n*Link Yt: https://youtube.com/channel/UCjOtJKGySNfDUvoA2D2c9_A', text, tescuk, cr)
					break
				case 'donasi':
				case 'donate':
				if (!isRegistered) return reply(ind.noregis())
				...
				case 'aslmulaikum':
				if (!isRegistered) return reply(ind.noregis())
					client.sendMessage(from, salam(), text)
					break
					case 'group':
				case 'gc':
				if (!isRegistered) return reply(ind.noregis())
					client.sendMessage(from, groups(), text)
					break
					case 'P':
				if (!isRegistered) return reply(ind.noregis())
					client.sendMessage(from, test(), text)
					break
                case 'level':
                if (!isRegistered) return reply(ind.noregis())
               ...
               client.sendMessage(from, resul, text, { quoted: mek})
                ...
                var gh = body.slice(12)
					...
					var wm = gh.split("|")[1];
					const pref = `Usage: \n${prefix}quotemaker teks|watermark\n\nEx :\n${prefix}quotemaker ini contoh|bacot`
			...
			if (isLimit(sender)) return reply(ind.limitend(pusname))
				...
				case 'add':
					...
					if (!isGroupAdmins) return reply(ind.admin())
					if (!isBotGroupAdmins) return reply(ind.badmin())
					if (args.length < 1) return reply('Yang mau di add jin ya? /n/n Masukin dulu nomernya😒')
            ...
            case 'creator':
                  ...
                  client.sendMessage(from, 'Itu kak nomer owner ku chat aja dia baik kok',MessageType.text, { quoted: mek} )
					break    
           case 'setname':
                if (!isGroup) return reply(ind.groupo())
			    if (!isGroupAdmins) return reply(ind.admin())
                ...
                client.sendMessage(from, 'Berhasil,Ubah Nama Group', text, {quoted: mek})
					break
                case 'setdesc':
                if (!isGroup) return reply(ind.groupo())
			    if (!isGroupAdmins) return reply(ind.admin())
           ...
           case 'demote':
					...
					if (mentioned.length > 1) {
						...
						for (let _ of mentioned) {
							teks += `Yah jabatan kamu di copot sebagai admin :\n`
							teks += `@_.split('@')[0]`
						}
				...
				case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝗦𝗲𝗹𝗮𝗺𝗮𝘁🥳 @${mentioned[0].split('@')[0]} anda naik menjadi admin group`, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					}
					break	
			     	case 'kick':
			...
			if (isGroup && !isCmd && isSimi && budy != undefined) {
						...
						console.log(color('[WORK]','blue'), 'Subscribe Rynz 01', color(sender.split('@')[0]))
					}
					}
		} catch (e) {
			console.log('Error : %s', color(e, 'red'))
